...
{
  //valida se o button de entrada manual foi pressionado e se foi digitado algum valor para enviar
  if (validar_Entrada_Manual && inputString != "" && character == 0)
  {
    lcd.setCursor(0, 2);
    lcd.print("");
  ...
  else if (count > 0 && !validar_Entrada_Manual && character != 0)
  {
    lcd.setCursor(0, 2);
    lcd.print("");
